...
From the plot we can see that when k = 10, the test and train plot is the smallest. When k >10 and k increases, test and train error also increase. Waht's more, AIC, BIC are similar with the train error. Therefore, suitable k value is about 10.
